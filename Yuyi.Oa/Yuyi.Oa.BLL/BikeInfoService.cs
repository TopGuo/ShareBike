...
{
    public class BikeInfoService:BaseService<BikeInfo>,IBikeInfoService
    {
        public override void SetCurrentDal()
        {
            CurrentDal = DbSession.GeBikeInfoDal;
        }
        ...
        /// <returns></returns>
        public IQueryable<BikeInfo> LoadPageData(UserQueryParam userQueryParam)
        {
            ...
            //分页  记得先排序
            var bikeInfos = temp.OrderBy(u => u.ID)
