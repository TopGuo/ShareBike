...
{
    public class YiquanInfoService:BaseService<YiquanInfo>,IYiquanInfoService
    {
        public override void SetCurrentDal()
        {
            CurrentDal = DbSession.GetYiquanInfoDal;
        }
        ...
        /// <returns></returns>
        public IQueryable<YiquanInfo> LoadPageData(UserQueryParam userQueryParam)
        {
            ...
            {
                temp = temp.Where(u => u.ID.ToString()==userQueryParam.SearchName);
            }
            ...
            //分页  记得先排序
            var yiquanInfos = temp.OrderBy(u => u.ID)
